...
<title>ABC CARS | CAR DETAIL</title>
<!--  Enable Bootstrap -->
<link
...
<div class="container">
	...
	<div class="container mb-5">
		<div class="card mb-5" style="margin-top: 20px; background-color: #002147; border: none;">
			<div class="row g-0">
					...
					<div class="p-3 right-side">
						...
						<div class="buttons d-flex flex-row mt-5 gap-3">
							...
							<button type="button" class="btn button2"
								...
								style="width: 500px; background-color: maroon; color: #ffffff;">Book for Test Drive</button>
							...
							<button type="button" class="btn button1" data-bs-toggle="modal"
								data-bs-target="#exampleModal" style="background-color: maroon; color: #ffffff;">Bid</button>
											...
											<sf:form action="bid" method="post" class="was-validated"
												...
												<div class="mb-3 mt-3">
													<label for="name" class="form-label">Bid Price
														(AUD):</label> <input type="text" class="form-control"
												...
												<button type="submit" class="btn button1">Bid
					...
					<table class="table table-bordered">
						<thead>
							<tr>
								...
								<th scope="col">Bidding Price (AUD)</th>
