...
<div class="container">
	...
	<div class="container">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<sf:form action="update" method="post" class="was-validated"
								...
								<button type="submit" class="btn button1">Update</button>
							</sf:form>
							<!-- User Update Form -->
						</div>
		...
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="card mb-4">
					<div class="card-body text-center" style="height: 284px; background-color:#002147;">
									...
									<table class="table table-bordered">
										<thead>
											<tr>
												...
												<th scope="col" style="color: white;">Car</th>
												<th scope="col" style="color: white;">Post Date</th>
												<th scope="col" style="color: white;">Action</th>
												<th scope="col" style="color: white;">Current Bid (AUD)</th>
												<th scope="col" style="color: white;">Bidder Name</th>
												<th scope="col" style="color: white;">Sale status</th>
											</tr>
										</thead>
										<tbody>
											<c:forEach items="${cars}" var="c" varStatus="status">
												<tr>
													...
													<td style="color: white;">${c.postDate}</td>
													<td>
													...
													<c:forEach items="${c.biddings}" var="b" begin="0" end="0">
														...
														<c:if test="${bidPrice > 0}">
															<td style="color: white;">${b.bidderPrice}</td>
															<td style="color: white;">${b.bidderName}</td>

														</c:if>
														<td style="color: white;">${c.sellStatus}</td>
													</c:forEach>
									...
									<table class="table table-bordered">
										<thead>
											<tr>
												...
												<th scope="col" style="color: white;">Car</th>
												<th scope="col" style="color: white;">Book Date</th>
												<th scope="col" style="color: white;">Book By</th>
												<th scope="col" style="color: white;">Book Status</th>
												...
												<c:forEach items="${c.biddings}" var="b">
													...
													<c:if test="${bookDate != null}">
														<tr>
															<th scope="row" style="color: white;">${status.count}</th>
															<td style="color: white;">${c.name}</td>
															<td style="color: white;">${b.bookDate}</td>
															<td style="color: white;">${b.bidderName}</td>
															<td style="color: white;">${b.bookStatus}</td>
														</tr>
													</c:if>
												</c:forEach>
											</c:forEach>
									...
									<table class="table table-bordered">
										<thead>
											<tr>
												...
												<th scope="col" style="color: white;">Car</th>
												<th scope="col" style="color: white;">Book Status</th>
												<th scope="col" style="color: white;">View Car</th>
											</tr>
										</thead>
										<tbody>
